...
contract CharacterMarket is ReentrancyGuard {
    ...
    // get the listing price for the collection
    function getListingPrice() public view returns(uint256) {
        return listingPrice;
    }


    //Create a new market Items, takes the character contract address as a parameter
    ...
    // Fetch items created by a particular _user
    ...
    // Fetch items sold by a particular user
